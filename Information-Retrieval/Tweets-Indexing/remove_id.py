...
fname="./search/search_and_saved_14_sept_2055en.json"
#fname="processed_json/*.json"
#fname="11stream_0124hr.json"
twt=[]
sfname="../mom_account/searched_tweets/trunc_id/new/search_and_saved_14_sept_2055en.json"
rt_prefix="ttext_"
...
('stanimal','Sports'),('trophy','Sports'),('wii','Sports'),('stantheman','Sports'),(' api ','Sports')])
'''
